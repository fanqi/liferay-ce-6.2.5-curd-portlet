...
import xyz.fanqi.liferay.demo.model.StudentClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"liferay-ce-6.2.5-curd-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "liferay-ce-6.2.5-curd-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"xyz.fanqi.liferay.demo.model.impl.StudentImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("xyz.fanqi.liferay.demo.NoSuchStudentException")) {
			return new xyz.fanqi.liferay.demo.NoSuchStudentException();
		}
